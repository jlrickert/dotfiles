...
nnoremap("<leader>sG", require("telescope.builtin").git_status, { desc = "[S]earch by [G]it status" })
...
nnoremap("<leader>sa", require("telescope.builtin").builtin, { desc = "[S]search [A]ll" })
nnoremap("<leader>sc", function()
	require("telescope.builtin").commands(require("telescope.themes").get_dropdown({
		previewer = false,
	}))
end, { desc = "[S]earch command [P]allet" })
