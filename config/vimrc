...
" goto old cursor position on file open
augroup resCur
  autocmd!
...
" Close popup with <Space> and add a space.
inoremap <expr><Space> pumvisible() ? neocomplete#close_popup() . "\<Space>" : "\<Space>"

" set timeoutlen=1000 ttimeoutlen=0

" Alt completions cycle
" inoremap <expr><Esc>n "\<C-n>"
" inoremap <expr><Esc>p "\<C-p>"

" nnoremap <expr><Esc>n "\<C-n>"
